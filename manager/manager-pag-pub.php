...
?>
		...
		<div class="row">
			<div class="col-lg-12">
				<ol class="breadcrumb">
					...
					<li class="active">Gestisci publications</a></li>
				</ol>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
				<h2>Gestisci publications</h2>
			</div>
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
				<a href="inserisci-pub.php"><button type="button" class="btn btn-success btn-lg testo-btn-piccolo">Inserisci</button></a>
			</div>
		</div>
...
?>
		...
		<div class="col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12">
			<div class="alert alert-danger testo-centrato spazio-alto"><strong>NON SONO PRESENTI PUBLICATIONS NEL MANAGER</strong></div>
		</div>
...
?>
		...
		<form name="modulo" method="post" action="eliminato-pub.php">	
			<div class="row">
...
?>
				...
				<div class="riga-alta">
					...
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
						<div class="elenco-pag"><?php echo $riga['titolo']; ?></div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
						<div class="elenco-pag"><?php if($riga['tipo']=="1") echo "Articolo"; else echo "Libro"; ?></div>
					</div>
					<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
						<a href="modifica-pub.php?id=<?php echo $riga['id']; ?>"><button type="button" class="btn btn-warning btn-largo btn-stretto"><span class="hidden-xs">Modifica</span><span class="visible-xs">Mod.</span></button></a>
					</div>
				</div>
