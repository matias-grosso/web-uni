		...
		<div class="row">
			<div class="col-lg-12">
				<ol class="breadcrumb">
					...
					<li class="active">Gestisci biosketch</a></li>
				</ol>
			</div>
		</div>
		...
		<div class="row spazio-altino">
			...
			<div class="riga-alta">
				...
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
					<a href="modifica-bio.php?id=1"><button type="button" class="btn btn-warning btn-largo btn-stretto"><span class="hidden-xs">Modifica</span><span class="visible-xs">Mod.</span></button></a>
				</div>
			</div>
			<div class="riga-alta">
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-9">
					<div class="elenco-pag">
						TAB EXPERIENCE, TECHNICAL SKILLS, PROJECTS, COURSES
					</div>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
					<a href="manager-extrabio.php"><button type="button" class="btn btn-primary btn-largo btn-stretto"><span class="hidden-xs">Gestisci</span><span class="visible-xs">Gest.</span></button></a>
				</div>
			</div>
		</div>
