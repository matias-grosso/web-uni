...
?>
				...
				<div class="lista-bio">
					<!-- TITOLO -->
					<div class="col-lg-11 col-md-11 col-sm-11 col-xs-10">
						<div class="titolo-lista-bio">ESPERIENZE</div>
					</div>
					<!-- IMMAGINE + O - PER APRIRE IL COLLAPSE -->
...
?>
				...
				<div class="lista-bio">
					<div class="col-lg-11 col-md-11 col-sm-11 col-xs-10">
						<div class="titolo-lista-bio">COMPETENZE TECNICHE</div>
					</div>
					<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 ruota">
...
?>
							<div class="no-elementi-bio">
								Non sono presenti competenze tecniche.
							</div>
<?php
	}
	else{
...
?>
				...
				<div class="lista-bio">
					<div class="col-lg-11 col-md-11 col-sm-11 col-xs-10">
						<div class="titolo-lista-bio">PROGETTI</div>
					</div>
					<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 ruota">
...
?>
				...
				<div class="lista-bio distanza-sotto">
					<div class="col-lg-11 col-md-11 col-sm-11 col-xs-10">
						<div class="titolo-lista-bio">NUOVI E VECCHI CORSI</div>
					</div>
					<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 ruota">
