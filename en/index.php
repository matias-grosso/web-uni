...
<?php
			//MAX CARATTERI
			$maxCaratteri=30; 
			$caratteri=strlen($riganews['titolo_en']); 
			if ($caratteri>$maxCaratteri){
				echo substr($riganews['titolo_en'], 0, $maxCaratteri)."...";
			}
			else{
				echo $riganews['titolo_en'];
			}
?>
								</div>
							</a>
...
?>
				<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12 distanza fix-colonna-contacts">
					...
					<div class="colonna-dx spazio-contact">
						...
						<div class="titolo-colonna-dx font-verde text-center vollkorn">Contacts</div>
