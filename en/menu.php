			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
			            ...
			            <li <?php if($titolo=="Publications"){ ?>class="active"<?php } ?>><a href="publications.php">Publications</a></li>
			            <li <?php if($titolo=="Teaching"){ ?>class="active"<?php } ?>><a href="teaching.php">Teaching</a></li>
						<li <?php if($titolo=="Biosketch"){ ?>class="active"<?php } ?>><a href="biosketch.php">Biosketch</a></li>
					</ul>
					<ul class="nav navbar-nav navbar-right">
						<!--<li><a href="index.php"><img src="img/ita.png" class="bandiere"></a></li>-->
						<li class="hidden-xs" style="margin-right:0;"><a href="../index.php"><img src="../img/ita.png" class="bandiere"></a></li>
						<li class="visible-xs"><a href="../index.php"><img src="../img/ita.png" class="bandiere"> Italian Version</a></li>
					</ul>
				</div>
			</div>
		</div>